        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="bg-brand-gray rounded p-8 text-center mt-12">
              ...
              <a
                href="https://wa.me/919876543210?text=Hi Printkul! I have a question about your products."
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-6 py-3 bg-brand-blue text-white rounded-lg hover:hover:bg-brand-blue-dark transition-colors"
              >
