        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/visiting-cards" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Visiting Cards</Link></li>
              <li><Link href="/signs-marketing" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Signs & Marketing</Link></li>
              <li><Link href="/stationery" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Stationery</Link></li>
              <li><Link href="/labels-stickers" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Labels & Stickers</Link></li>
              <li><Link href="/photo-gifts" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Photo Gifts</Link></li>
              <li><Link href="/deals" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Deals & Offers</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li><Link href="/about" className="text-white/60 hover:text-brand-blue transition-colors text-sm">About Us</Link></li>
              <li><Link href="/contact" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Contact</Link></li>
              <li><Link href="/faq" className="text-white/60 hover:text-brand-blue transition-colors text-sm">FAQs</Link></li>
              <li><Link href="/account" className="text-white/60 hover:text-brand-blue transition-colors text-sm">My Account</Link></li>
              <li><Link href="/account/orders" className="text-white/60 hover:text-brand-blue transition-colors text-sm">Order History</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start gap-2.5">
                <MessageCircle className="w-4 h-4 text-brand-blue mt-0.5 flex-shrink-0" />
                <a href="https://wa.me/919876543210" className="text-white/60 hover:text-brand-blue text-sm transition-colors">WhatsApp Support</a>
              </li>
            </ul>
          </div>
        </div>
